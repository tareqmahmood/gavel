...
def simulate_with_timeout(experiment_id, policy_name,
    ...
    if verbose:
        ...
        print('[%s] [Experiment ID: %2d] '
              ...
              'seed=%d, num_total_jobs=%d, lambda=%d' % (current_time,
                                              experiment_id,
                                              cluster_spec_str,
                                              policy.name,
                                              seed, num_total_jobs, args.lam))
    ...
    for cluster_spec_str in args.cluster_spec:
        ...
        for policy_name in policy_names:
            ...
            for num_total_jobs in all_num_total_jobs:
                lam = args.lam * 60  # lambda value for Poisson process per minute
...
if __name__=='__main__':
    ...
    parser.add_argument('--lam', type=int, default=5,
                        help='Lambda value for Poisson process per minute')
