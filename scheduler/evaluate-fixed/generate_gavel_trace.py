...
def main(args):
    ...
    multi_gpu_model_list = ['Bert-Large', 'GPT2-Medium', 'Bert-Base', 'GPT2-XL', 'GPT2']
    all_model_list = single_gpu_model_list + multi_gpu_model_list
    batch_size_range = [32, 64, 128]

    # Resnet: 32, VGG-19: 32, PointNet: 32, DCGAN: 128
    # Bert-Base: 2, GPT2: 2, Bert-Large: 4, GPT2-Medium: 4, GPT2-XL: 8
    batch_size_model = {
        'resnet50': 32,
        'vgg19': 32,
        'PointNet': 32,
    ...
    for i in range(args.num_jobs):
        ...
        batch_size = batch_size_model[model_name]
